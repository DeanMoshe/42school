...
/*   Updated: 2022/02/01 05:28:15 by cgrayson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pa(t_stack *first, t_stack *second, int print_op, t_info *desc)
{
...
void	pb(t_stack *first, t_stack *second, int print_op, t_info *desc)
{
	if (ft_stack_is_empty(first))
		return ;
	ft_push_other_stack(first, second);
